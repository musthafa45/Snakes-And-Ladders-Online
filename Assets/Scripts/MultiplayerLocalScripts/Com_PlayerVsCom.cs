...
public class Com_PlayerVsCom : MonoBehaviour
{
    public static Com_PlayerVsCom Instance { get; private set; }
    public event Action OnComputerMoveDone;
    ...
    private IEnumerator MoveOneByOne(int targetTileIndex) {
        ...
        if (diceBoard.GetAllTile()[^1].GetTileId() == targetTileId) {
            ...
            WinLossUi_PlayerVsCom.Instance.ShowLossUi();
